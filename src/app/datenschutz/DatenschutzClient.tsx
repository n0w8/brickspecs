...
export default function DatenschutzClient() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-1 pt-14 pb-20 text-sm leading-relaxed">
      ...
      <p>
        {de
          ? "Funktionen wie Sprachwahl, Portfolio, Preisalarme, Länderauswahl und Plan-Vormerkung speichern ihre Daten im localStorage deines Browsers. Diese Inhalte verlassen ohne Nutzerkonto dein Gerät nicht. Du kannst sie jederzeit über die Browser-Einstellungen löschen. Da es sich um technisch erforderliche, rein lokale Speicherung handelt, ist kein Cookie-Banner nötig."
          : "Features like language choice, portfolio, price alerts, country selection and plan preselection store their data in your browser's localStorage. Without a user account these contents never leave your device. You can delete them at any time via your browser settings. As this is technically required, purely local storage, no cookie banner is needed."}
      </p>

      <H2>{de ? "5a. Online-Zähler (Präsenz)" : "5a. Online counter (presence)"}</H2>
      <p>
        {de
          ? "Um anzuzeigen, wie viele Personen gerade online sind, erzeugt dein Browser eine zufällige, nicht personenbezogene Kennung (localStorage-Eintrag 'bricktopia.sid') und meldet sie etwa einmal pro Minute an unseren Server. Gespeichert werden nur diese Zufallskennung und der Zeitpunkt der letzten Aktivität; alte Einträge werden laufend gelöscht. Ein Rückschluss auf deine Person, dein Konto oder dein Surfverhalten ist damit nicht möglich. Rechtsgrundlage ist unser berechtigtes Interesse an einer Live-Aktivitätsanzeige (Art. 6 Abs. 1 lit. f DSGVO). Du kannst die Kennung jederzeit über die Browser-Einstellungen löschen."
          : "To show how many people are currently online, your browser generates a random, non-personal identifier (localStorage entry 'bricktopia.sid') and reports it to our server about once per minute. Only this random identifier and the time of last activity are stored; old entries are deleted continuously. It cannot be linked to your person, your account or your browsing behaviour. The legal basis is our legitimate interest in a live activity display (Art. 6(1)(f) GDPR). You can delete the identifier at any time via your browser settings."}
      </p>
