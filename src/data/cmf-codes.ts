...
//
// Seit Serie 24 stecken die Sammelfiguren in Kartons statt Tüten. Auf der
...
// Brick Fanatics. Redaktionell gepflegt - neue Serien hier ergänzen.
...
export const CMF_SERIES: CmfSeries[] = [
  {
    ...
    figures: [
      ...
      { no: 4, name: { de: "Monsterjäger", en: "Monster Hunter" }, codes: ["6603328", "6605254"] },
      { no: 5, name: { de: "Bubble-Tea-Fan", en: "Boba Cup Fan" }, codes: ["6603324", "6605250"] },
      { no: 6, name: { de: "Müllmonster", en: "Trash Monster" }, codes: ["6603330", "6605256"] },
      ...
      { no: 9, name: { de: "Fußball-Torhüterin", en: "Soccer Goalkeeper" }, codes: ["6603320", "6605246"] },
      { no: 10, name: { de: "Süße Hexe", en: "Cute Witch" }, codes: ["6603329", "6605255"] },
      { no: 11, name: { de: "Mysteriöser Ronin", en: "Mysterious Ronin" }, codes: ["6603327", "6605253"] },
  ...
  },
  {
    ...
    figures: [
      ...
      { no: 10, name: { de: "Süßer Hase", en: "Cute Bunny" }, codes: ["6584393", "6584380"] },
      { no: 11, name: { de: "Löwe", en: "Lion" }, codes: ["6584388", "6584375"] },
...
export interface CmfMatch {
  series: CmfSeries;
  figure: CmfFigure;
  /** Der Code, über den der Treffer zustande kam */
  code: string;
}
